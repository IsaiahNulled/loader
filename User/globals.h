...
inline bool g_customFovEnabled = false;
inline float g_customFov = 90.0f;
...
inline bool& g_fovChangerEnabled = g_customFovEnabled;
inline float& g_gameFov = g_customFov;
inline int g_zoomKey = VK_XBUTTON2; // default: side mouse 2
inline float g_zoomFov = 25.0f;
inline bool g_isZooming = false;
inline float g_priorFov = 90.0f; // saved FOV before zoom
inline bool g_noRecoilHasLocal = false;
inline bool g_noRecoilHasWeapon = false;

// Movement exploits
inline bool g_spiderman = false;
inline bool g_flyhack = false;
inline bool g_omniSprint = false;
...
inline bool g_thirdPerson = false;
...
inline unsigned int g_chamsMaterialId = 763998; // current chams material ID
inline std::string g_chamsMaterialName = "Solid White"; // display name
inline bool g_viewModelChams = false; // hand + weapon chams
inline unsigned int g_vmChamsMaterialId = 763998; // view model material ID
inline std::string g_vmChamsMaterialName = "Solid White";
...
// ESP refresh rate (ms)
inline const int g_espRefreshMs = 5;
